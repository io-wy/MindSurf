...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/best_seq768_from_wsd_cooldown"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_seq768_lr5e6" \
    --save_weight best_seq768_from_wsd_cooldown_seq768_lr5e6 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_seq768_lr5e6/best_seq768_from_wsd_cooldown_seq768_lr5e6_768.pth"
