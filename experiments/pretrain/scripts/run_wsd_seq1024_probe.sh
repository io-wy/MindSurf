...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/wsd_seq1024_probe"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_seq1024_lr1e5" \
    --save_weight wsd_seq1024_probe_seq1024_lr1e5 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_seq1024_lr1e5/wsd_seq1024_probe_seq1024_lr1e5_768.pth"
