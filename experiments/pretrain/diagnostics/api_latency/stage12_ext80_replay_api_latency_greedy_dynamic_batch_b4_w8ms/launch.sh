...
run_case "stage12_ext80_replay_api_latency_greedy_nostream_no_batch" "$BASE_PORT"
run_case "stage12_ext80_replay_api_latency_greedy_dynamic_batch_b4_w8ms" "$((BASE_PORT + 1))" \
  --dynamic_batching \
  --batch_max_size 4 \
  --batch_wait_ms 8
