...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/lr1e4_s384_from_baseline"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_s384_lr1e4" \
    --save_weight lr1e4_s384_from_baseline_s384_lr1e4 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_s384_lr1e4/lr1e4_s384_from_baseline_s384_lr1e4_768.pth"
