...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/lr2e5_s384_from_baseline"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_s384_lr2e5" \
    --save_weight lr2e5_s384_from_baseline_s384_lr2e5 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_s384_lr2e5/lr2e5_s384_from_baseline_s384_lr2e5_768.pth"
