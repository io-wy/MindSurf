...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/from_best_seq768_seq768_lr2e6"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_seq768_lr2e6" \
    --save_weight from_best_seq768_seq768_lr2e6 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_seq768_lr2e6/from_best_seq768_seq768_lr2e6_768.pth"
