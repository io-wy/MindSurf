...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/stable06_cooldown_seq512"
BASE="experiments/pretrain/platform_runs/wsd_s384_stable06/01_wsd_s384/wsd_s384_stable06_wsd_s384_768.pth"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    ...
    --save_weight stable06_cooldown_seq512_s384_lr5e5 \
    --init_weight "$BASE" \
  ...
  STAGE1="$OUT/01_s384_lr5e5/stable06_cooldown_seq512_s384_lr5e5_768.pth"
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/02_seq512_lr1e5" \
    --save_weight stable06_cooldown_seq512_seq512_lr1e5 \
    --init_weight "$STAGE1" \
    --data_path experiments/pretrain/strict_splits/pretrain_strict_train.jsonl \
    --tokenizer_path model \
    --epochs 1 \
  ...
  STAGE2="$OUT/02_seq512_lr1e5/stable06_cooldown_seq512_seq512_lr1e5_768.pth"
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/03_seq512_lr3e6" \
    --save_weight stable06_cooldown_seq512_seq512_lr3e6 \
    --init_weight "$STAGE2" \
    --data_path experiments/pretrain/strict_splits/pretrain_strict_train.jsonl \
    --tokenizer_path model \
    --epochs 1 \
  ...
  WEIGHT="$OUT/03_seq512_lr3e6/stable06_cooldown_seq512_seq512_lr3e6_768.pth"
