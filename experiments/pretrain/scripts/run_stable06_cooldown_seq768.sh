...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/stable06_cooldown_seq768"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    ...
    --save_weight stable06_cooldown_seq768_s384_lr5e5 \
    --init_weight "$BASE" \
  ...
  STAGE1="$OUT/01_s384_lr5e5/stable06_cooldown_seq768_s384_lr5e5_768.pth"
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/02_seq768_lr5e6" \
    --save_weight stable06_cooldown_seq768_seq768_lr5e6 \
    --init_weight "$STAGE1" \
    --data_path experiments/pretrain/strict_splits/pretrain_strict_train.jsonl \
    --tokenizer_path model \
    --epochs 1 \
  ...
  WEIGHT="$OUT/02_seq768_lr5e6/stable06_cooldown_seq768_seq768_lr5e6_768.pth"
