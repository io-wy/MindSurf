...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/long_seq768_from_baseline"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_seq768_lr1e5" \
    --save_weight long_seq768_from_baseline_seq768_lr1e5 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_seq768_lr1e5/long_seq768_from_baseline_seq768_lr1e5_768.pth"
