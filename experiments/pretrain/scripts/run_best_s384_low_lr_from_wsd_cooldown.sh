...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/best_s384_low_lr_from_wsd_cooldown"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/01_s384_lr1e5" \
    --save_weight best_s384_low_lr_from_wsd_cooldown_s384_lr1e5 \
    --init_weight "$BASE" \
  ...
  WEIGHT="$OUT/01_s384_lr1e5/best_s384_low_lr_from_wsd_cooldown_s384_lr1e5_768.pth"
