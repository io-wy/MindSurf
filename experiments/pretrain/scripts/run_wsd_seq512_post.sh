...
PY=".venv/bin/python"
OUT="experiments/pretrain/platform_runs/wsd_seq512_post"
...

{
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    ...
    --save_weight wsd_seq512_post_seq512_lr2e5 \
    --init_weight "$BASE" \
  ...
  STAGE1="$OUT/01_seq512_lr2e5/wsd_seq512_post_seq512_lr2e5_768.pth"
  "$PY" experiments/pretrain/scripts/train_pretrain_optimized.py \
    --save_dir "$OUT/02_seq512_lr5e6" \
    --save_weight wsd_seq512_post_seq512_lr5e6 \
    --init_weight "$STAGE1" \
    --data_path experiments/pretrain/strict_splits/pretrain_strict_train.jsonl \
    --tokenizer_path model \
    --epochs 1 \
  ...
  WEIGHT="$OUT/02_seq512_lr5e6/wsd_seq512_post_seq512_lr5e6_768.pth"
